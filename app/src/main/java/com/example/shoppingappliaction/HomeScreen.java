...
public class HomeScreen extends AppCompatActivity implements CoffeeName,ParticularCoffeeDetails {
    ...
    AutoCompleteTextView coffeeName_et;
    ImageView search_iv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coffee_list_Adapter = new CoffeListRecyclerView(coffee_list,coffeeName_et.getText().toString() ,true,this, this);
        ...
        coffeeName_et.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                coffee_list_Adapter.notifyDataSetChanged();
            }
    ...
    @Override
    public void getParticularCoffeeDetails(byte[] src, String coffeeName, String extaraDetails, String money, String add_view) {
