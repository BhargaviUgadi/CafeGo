    ...
    public void onBindViewHolder(@NonNull ParticularCoffeeRecyclerView.ParticularViewHolder holder, int position) {
      ...
      holder.addCart.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
              ...
              detailsCoffeePojoClassArrayList.get(position).getmImageView().compress(Bitmap.CompressFormat.PNG, 99, bs);
              particularCoffeeDetails1.getParticularCoffeeDetails(bs.toByteArray(),detailsCoffeePojoClassArrayList.get(position).getCoffeeName(),detailsCoffeePojoClassArrayList.get(position).getExtraDetails(),detailsCoffeePojoClassArrayList.get(position).getMoney(),"add");
          }
      });
      ...
      holder.coffee_cardview.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
              ByteArrayOutputStream bs = new ByteArrayOutputStream();
              detailsCoffeePojoClassArrayList.get(position).getmImageView().compress(Bitmap.CompressFormat.PNG, 99, bs);
              particularCoffeeDetails1.getParticularCoffeeDetails(bs.toByteArray(),detailsCoffeePojoClassArrayList.get(position).getCoffeeName(),detailsCoffeePojoClassArrayList.get(position).getExtraDetails(),detailsCoffeePojoClassArrayList.get(position).getMoney(),"view");
